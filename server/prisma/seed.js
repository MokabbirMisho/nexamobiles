...
async function main() {
  ...
  await prisma.user.upsert({
    where: { email: "miso@admin.com" },
    update: { passwordHash: adminPass, isAdmin: true },
    create: {
      name: "Admin",
      email: "miso@admin.com",
      passwordHash: adminPass,
      isAdmin: true,
    },
  });
  await prisma.user.upsert({
    where: { email: "miso@customer.com" },
    update: { passwordHash: custPass },
    create: {
      name: "Demo Customer",
      email: "miso@customer.com",
  ...
  const products = [
    {
      ...
      price: 799.0,
      description:
        "A total powerhouse. The iPhone 15 features the Dynamic Island, a 48MP main camera and USB-C.",
      mainImage:
    ...
    },
    {
      ...
      price: 749.0,
      description:
        'Galaxy AI is here. Brilliant 6.2" display and a pro-grade camera system.',
      mainImage:
    ...
    },
    {
      ...
      price: 449.0,
      description:
        "Studio-quality portraits with the Aura Light and a sleek slim design.",
      mainImage:
    ...
    },
    {
      ...
      price: 399.0,
      description:
        "Portrait expert with a vivid curved display and fast 67W charging.",
      mainImage:
    ...
    },
    {
      ...
      price: 329.0,
      description:
        "Periscope portrait camera and a premium vegan-leather finish.",
      mainImage:
    ...
    },
    {
      ...
      price: 249.0,
      description:
        "Up to 2x more Active Noise Cancellation with Adaptive Audio and USB-C.",
      mainImage:
